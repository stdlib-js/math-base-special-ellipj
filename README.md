...
```javascript
import ellipj from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-ellipj@v0.3.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { am, assign, cn, dn, sn } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-ellipj@v0.3.0-deno/mod.js';
```
